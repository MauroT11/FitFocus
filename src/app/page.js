  ...
  return (
    <div className="flex flex-col">
      ...
      <section id="whatIs" className="flex flex-col items-center gap-8 py-32">
        ...
        <div className="grid grid-cols-3 gap-36 text-center">
          <div className="flex flex-col gap-2 items-center">
            <BsCalculatorFill className="text-8xl" />
            <h3 className="text-3xl">Calculations</h3>
            <p className="max-w-[25rem]">Find out your BMI, daily calorie requirements, body fat percentage and more with our calculators.</p>
          </div>
          <div className="flex flex-col gap-2 items-center">
            <GiMeal className="text-8xl" />
            <h3 className="text-3xl">Macros</h3>
            <p className="max-w-[25rem]">Find out your recommended daily calorie intake and macronutrients.</p>
          </div>
          <div className="flex flex-col gap-2 items-center">
            <FaDumbbell className="text-8xl" />
            <h3 className="text-3xl">Workouts</h3>
            <p className="max-w-[25rem]">Discover workouts for your gym sessions to target specific muscle groups.</p>
          </div>
        </div>
      </section>
      ...
      <section className="flex flex-col gap-8 bg-base-200 items-center py-32">
        ...
        <div className="grid grid-cols-2 gap-[6rem] items-center text-center">
          <Image src={Scale} width={600} height={600} alt="Photo of Scale" className="rounded-2xl" />
          <div className="max-w-[40rem] flex flex-col gap-4">
            <h2 className="text-2xl font-bold">Find your metrics</h2>
          ...
          <div className="max-w-[40rem] flex flex-col gap-4">
            <h2 className="text-2xl font-bold">Find your daily intake & macronutrients</h2>
          ...
          <div className="max-w-[40rem] flex flex-col gap-4">
            <h2 className="text-2xl font-bold">Library of workouts</h2>
